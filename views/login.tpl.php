	...
	<div class="container-lg">
        ...
        <form class="col-lg-6 offset-lg-3 py-4" method="post" action="/login">
            ...
            <div class="mb-3">
                ...
                <input type="email" class="form-control <?= isset($error['email']) ? 'is-invalid' : '' ?>" id="exampleInputEmail1" name="email" placeholder="Enter your email" autocomplete="email" aria-describedby="emailLoginFeedback">
                <div class="invalid-feedback" id="emailLoginFeedback">
                    <?= $error['email'] ?>
                </div>
            </div>
            <div class="mb-3">
                <label for="password" class="form-label">Password</label>
                <div class="password-container <?= isset($error['password']) ? 'password-container-invalid' : '' ?>">
